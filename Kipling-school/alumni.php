                                ...
                                <div class="col-6 text-right">
                                    <div class="chatacter">
                                         ...
                                         <?php
                                                ...
                                                $sql = "select * from endpage_alumni_kipling where id = 1";
                                ...
                                <div class="col-6 text-right">
                                    <div class="chatacter">
                                         ...
                                         <?php
                                                ...
                                                $sql = "select * from endpage_alumni_kipling where id = 2";
                                ...
                                <div class="col-6 text-right">
                                    <div class="chatacter">
                                         ...
                                         <?php
                                                ...
                                                $sql = "select * from endpage_alumni_kipling where id = 3";
                                ...
                                <div class="col-6 text-right">
                                    <div class="chatacter">
                                         ...
                                         <?php
                                                ...
                                                $sql = "select * from endpage_alumni_kipling where id = 4";
