                        ...
                        <div class="article">
                            <div class="row">
                                  <?php
                                        ...
                                        $sql = "SELECT * from current_events_lycee where id = 1";
                                ...
                                <div class="col-6 p-0">
                                    <div class="img">
                                        <?php
                                            ...
                                            $sql = "SELECT * from current_events_lycee where id = 2";
                        ...
                        <ul class="event-list">
                            ...
                            <li>
                                 <?php
                                            ...
                                            $sql = "SELECT *, MONTHNAME(event_day) as month, DAYOFMONTH(event_day) as day from upcoming_events_lycee where id = 1";
                            ...
                            <li>
                                 <?php
                                            ...
                                            $sql = "SELECT *, MONTHNAME(event_day) as month, DAYOFMONTH(event_day) as day from upcoming_events_lycee where id = 2";
                           ...
                           <li>
                                 <?php
                                            ...
                                            $sql = "SELECT *, MONTHNAME(event_day) as month, DAYOFMONTH(event_day) as day from upcoming_events_lycee where id = 3";
...
<li>
                                 <?php
                                            ...
                                            $sql = "SELECT *, MONTHNAME(event_day) as month, DAYOFMONTH(event_day) as day from upcoming_events_lycee where id = 4";
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <?php
                            ...
                            $sql = "SELECT * from endpage_lycee where id = 1";
                     ...
                     <div class="swiper-slide">
                        <?php
                            ...
                            $sql = "SELECT * from endpage_lycee where id = 2";
                     ...
                     <div class="swiper-slide">
                        <?php
                            ...
                            $sql = "SELECT * from endpage_lycee where id = 3";
                     ...
                     <div class="swiper-slide">
                        <?php
                            ...
                            $sql = "SELECT * from endpage_lycee where id = 4";
                    ...
                    <div class="swiper-slide">
                        <?php
                            ...
                            $sql = "SELECT * from endpage_lycee where id = 5";
