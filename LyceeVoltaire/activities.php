                ...
                <div class="container">
                    <div id="columns">
                         <?php
                            ...
                            $sql = "select * from lycee_activites where id = 1";
                        ...
                        <figure class="tile scale-anm athletics">
                         ...
                         <?php
                            ...
                            $sql = "select * from lycee_activites where id = 2";
                        ...
                        <figure class="tile arts">
                         ...
                         <?php
                            ...
                            $sql = "select * from lycee_activites where id = 3";
                        ...
                        <figure class="tile drama">
                         ...
                         <?php
                            ...
                            $sql = "select * from lycee_activites where id = 4";
                        ...
                        <figure class="tile travel">
                         ...
                         <?php
                            ...
                            $sql = "select * from lycee_activites where id = 5";
                        ...
                        <figure class="tile pta">
                         ...
                         <?php
                            ...
                            $sql = "select * from lycee_activites where id = 6";
